...
## ML
- [Perceptrons](ml_projects/perceptrons.pdf)

- [Pytorch and MNIST](ml_projects/pytorch_mnist.md)

- [Pytorch and fashion data](https://medium.com/ml2vec/intro-to-pytorch-with-image-classification-on-a-fashion-clothes-dataset-e589682df0c5)
...
## Neuroscience
- [spike predicton from real data](neuro_projects/spike_prediction/spike_prediction.md)
...
- [saliency](neuro_projects/saliency/saliency.pdf)
